 ...
 * @describe：
 */
@WebServlet("/accident/analysisLevel")
public class AccidentLevelServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        AccidentAnalyseService accidentAnalyseService = new LevelServiceImpl();
