 ...
 * @describe：
 */
public class SolutionDaoImpl implements AccidentAnalyseDao {
    @Override
    public List<AccidentAnalyse> getAll(AccidentCondition ac) {
        ...
        String sql1 = "select solution as 'name',count(*) as 'value' from accident";
        String sql2 = " where";
        String sql3 = " and";
        String sql4 = " type = ?";
        String sql5 = " time > ?";
        String sql6 = " time < ?";
        String sql7 = " group by solution";
